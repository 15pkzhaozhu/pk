...
public class StudentDAO extends BaseHibernateDAO {
	...
	public static final String DORMINUM = "dorminum";
	...
	public List findByApartment(Object apartment) {
		return findByProperty(APARTMENT, apartment);
	}

	public List findByDorminum(Object dorminum) {
		return findByProperty(DORMINUM, dorminum);
	}
